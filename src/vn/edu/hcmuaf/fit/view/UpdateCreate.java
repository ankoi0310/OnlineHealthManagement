...
public class UpdateCreate extends JFrame implements ActionListener {
	...
	public UpdateCreate(RequestController controller, Request request) {
...
//		tfAddress.addActionListener(this);
		...
		//
		taProblem = new JTextArea(request.getProblemDescription());
