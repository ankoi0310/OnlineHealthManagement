...
public class UpdatePatient extends JFrame implements ActionListener {
	...
	public void createView() {
		setTitle("Cập nhật thông tin bệnh nhân");
		...
		JLabel lblHeader = new JLabel("Cập nhật hông tin bệnh nhân");
		...
		tfCMND.setDisabledTextColor(Color.GRAY);
